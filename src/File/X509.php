 ...
 *
 * @package X509
 * @method bool|mixed[] loadX509(string $cert, int $mode = self::FORMAT_AUTO_DETECT)
 * @method string|false saveX509(mixed[] $cert, int $format = self::FORMAT_PEM)
 ...
 * @method mixed getDN(int $format = self::DN_ARRAY, mixed[] $dn = null)
 * @method mixed getIssuerDN(int $format = self::DN_ARRAY)
 * @method mixed getSubjectDN(int $format = self::DN_ARRAY)
 ...
 * @method bool|mixed[] loadCSR(string $csr, int $mode = self::FORMAT_AUTO_DETECT)
 * @method string|false saveCSR(array $csr, int $format = self::FORMAT_PEM)
 * @method bool|mixed[] loadSPKAC(string $spkac)
 * @method string|false saveSPKAC(array $spkac, int $format = self::FORMAT_PEM)
 * @method bool|mixed[] loadCRL(string $crl, int $mode = self::FORMAT_AUTO_DETECT)
 * @method string|false saveCRL(array $crl, int $format = self::FORMAT_PEM)
 ...
 * @method bool removeAttribute(string $id, int $disposition = self::ATTR_ALL)
 * @method mixed getAttribute(string $id, int $disposition = self::ATTR_ALL, array $csr = null)
